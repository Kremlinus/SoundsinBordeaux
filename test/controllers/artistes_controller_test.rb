...
class ArtistesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artiste" do
    assert_difference('Artiste.count') do
      post artistes_url, params: { artiste: { description: @artiste.description, image: @artiste.image, name: @artiste.name } }
    end
  ...
  test "should update artiste" do
    patch artiste_url(@artiste), params: { artiste: { description: @artiste.description, image: @artiste.image, name: @artiste.name } }
